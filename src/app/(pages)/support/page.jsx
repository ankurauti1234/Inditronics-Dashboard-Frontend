            ...
            <Accordion type="single" collapsible className="w-full">
              <AccordionItem value="item-1">
                ...
                <AccordionContent>
                  ...
                  the login page. Follow the instructions sent to your email to
              ...
              <AccordionItem value="item-2">
                ...
                <AccordionContent>
                  Unfortunately, usernames cannot be changed once an account is
                  created. However, you can update your display name in your
                  account settings.
                </AccordionContent>
              </AccordionItem>
